...
class GameDialog {
  ...
  static List<Say> introMeetTheHero() {
    return [
      ...
      _speak(text: "Welcome, Eco Hero! You’ve arrived just in time. Our city is in trouble, and only you can save it from the clutches of the Ecofiend!", isHero: false, imagepath: narrator),
